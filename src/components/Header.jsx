      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-md-auto d-md-flex align-items-md-center  gap-3">
            <Link to={'/wishlist'} className="text-decoration-none  text-white fw-bold  ms-md-5 d-flex align-items-center"> <FontAwesomeIcon icon={faHeart} className='text-white'></FontAwesomeIcon> WishList<Badge pill bg="info">{useWishlist?.length}</Badge></Link>
            <Link to={'/cart'} className="text-decoration-none text-white fw-bold me-5 "> <FontAwesomeIcon icon={faCartShopping} className="text-white me-1"></FontAwesomeIcon> Cart<Badge pill bg="dark"className="ms-1">20</Badge></Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
